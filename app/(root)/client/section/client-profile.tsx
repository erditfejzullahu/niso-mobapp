          ...
          <View className='overflow-hidden'>
            <Animated.View entering={BounceInUp.easing(Easing.inOut(Easing.bounce))} className='p-4'>
              ...
              <TouchableOpacity
                ...
                className={`rounded-2xl mt-2 bg-indigo-600 p-3 ${((newPassword !== confirmNewPassword) || (!newPassword || !confirmNewPassword)) && "opacity-50"}`}
              >
                <Text className='font-pregular text-center text-white'>Ndryshoni fjalëkalimin</Text>
              </TouchableOpacity>
            </Animated.View>
          </View>
        )}
