    ...
    const renderRideItem = useCallback(({ item, index }: { item: RideListItem; index: number }) => {
        ...
        return (
            <CardShell
                ...
                onPress={() => router.push(`/(root)/client/section/my-ride-requests/${item.rideRequest.id}`)}
            />
        );
    }, []);
        ...
        <View className='flex-1 bg-gray-50'>
            ...
            <View style={styles.header} className='mt-4'>
                ...
                <View style={styles.headerTitles}>
                    <Text style={styles.headerTitle}>Kërkesat e mia</Text>
                    <Text style={styles.headerSubtitle}>Të gjitha kërkesat dhe udhëtimet</Text>
                </View>
