...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingTop: 0, paddingHorizontal: 12 },
  profileSection: {
    paddingVertical: 40,
  ...
  drawerItemsContainer: { marginTop: 10, paddingHorizontal: 4 },
  drawerItem: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 12,
  ...
  activeDrawerLabel: { color: "#fff" },
  logoutSection: { padding: 20, borderTopWidth: 1, borderColor: "#e5e7eb" },
  logoutButton: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
