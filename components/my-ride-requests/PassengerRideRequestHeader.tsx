        ...
        <View className="bg-white rounded-2xl mx-4 mb-2 px-4 py-3 mt-4 shadow shadow-black/5">
            ...
            <View className="flex-row items-center">
                ...
                <View className="flex-1">
                    <Text className="text-base font-psemibold text-gray-900" numberOfLines={1}>
                        {ride?.driver?.fullName ?? 'Ende pa shofer të caktuar'}
                    </Text>
                    {!!relativeCreated && (
                ...
                {ride?.isUrgent ? (
                    <View className="bg-red-100 px-2 py-1 rounded-full flex-row items-center">
                        ...
                        <Text className="ml-1 text-red-600 text-xs font-psemibold">Urgjente</Text>
                    </View>
                ) : null}
            </View>
...
export default PassengerRideRequestHeader;
